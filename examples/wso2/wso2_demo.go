...
func main() {
	...
	// login handler
       //githubHandler := auth.Github(*githubClientKey, *githubSecretKey, "openid")
       githubHandler := auth.Wso2(*githubClientKey, *githubSecretKey,"openid", "http://jeff-beego.rxwiki.com/auth/login")
